    ...
    public function get()
    {
        ...
        if (!empty($this->name)) {
            $buf = '<img id="SPAW_'
                   ...
                   . '\',this)" class="SPAW_'
                   . $this->theme
                   . '_tb_out" onMouseOver="SPAW_'
                   . $this->theme
                   . '_bt_over(this)" onMouseOut="SPAW_'
                   . $this->theme
                   . '_bt_out(this)" onMouseDown="SPAW_'
                   . $this->theme
                   . '_bt_down(this)" onMouseUp="SPAW_'
                   . $this->theme
                   . '_bt_up(this)"  '
                   . $this->attributes
                   . ' unselectable="on">';
    ...
    public function get()
    {
        ...
        if (!empty($this->name)) {
            $buf = '<select size="1" id="SPAW_'
                   ...
                   . '_tb_'
                   . $this->name
                   . '" align="absmiddle" class="SPAW_'
                   . $this->theme
                   . '_tb_input" onchange="SPAW_'
                   . $this->name
                   . '_change(\''
                   . $this->editor
                   . '\',this)" '
        ...
        if (!empty($this->toolbars[$pos . '_' . $mode])) {
            ...
            while (list(, $tb) = each($this->toolbars[$pos . '_' . $mode])) {
                ...
                while (list(, $tbitem) = each($tb['data'])) {
                    //Added by vivi to prevent unset vars

                    if (false === isset($tbitem['data'])) {
                        $tbitem['data'] = '';
                    }

                    if (false === isset($tbitem['attributes'])) {
                        $tbitem['attributes'] = '';
                    }
