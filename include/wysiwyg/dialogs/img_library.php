...
//                                www.solmetra.com
// ================================================
// $Revision: 1.1 $, $Date: 2006/03/27 15:49:42 $
// ================================================

//Added by vivi to solve url problems
    ...
    <script language="javascript">
        ...
        function selectClick() {
            if (document.libbrowser.lib.selectedIndex >= 0 && document.libbrowser.imglist.selectedIndex >= 0) {
                //Modified by vivi for compatibility
                window.returnValue = document.libbrowser.lib.options[document.libbrowser.lib.selectedIndex].value + document.libbrowser.imglist.options[document.libbrowser.imglist.selectedIndex].value;
                window.close();
            } else {
                    ...
                    <select name="imglist" size="15" class="input" style="width: 150px;"
                        ...
                        if ($d) {
                            while (false !== ($entry = $d->read())) {
                                if (is_file($spaw_base_url . $imglib . $entry)) {
                                    ?>
